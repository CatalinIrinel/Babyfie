...
export const termsData = [
  {
    ...
    texts: [
      <Text>
        ...
        you, whether personally or on behalf of an entity (“you”) and Babyfie
        SRL (<strong>"Company", “we”, “us”, or “our”</strong>), concerning your
        access to and use of the{' '}
        <a href="https://babyfie.eu">https://babyfie.eu</a> website as well as
        any other media form, media channel, mobile website or mobile
        application related, linked, or otherwise connected thereto
        (collectively, the “Site”). We are registered in Romania and have our
        registered office at Salciilor 100B, Constanta, Constanta 900005. Our
        VAT number is RO14523. You agree that by accessing the Site, you have
  ...
  {
    title: '2. intelectual property rights',
    texts: [
      <Text>
  ...
  },
  {
    ...
    texts: [
      ...
      <Text>
        ...
        change prices at any time. All payments shall be in RON.
      </Text>,
      <Text>
    ...
    texts: [
      ...
      <UnorderedList>
        ...
        <ListItem>
          ...
          abuse anyone. Your Contributions are not used to harass or threaten
  ...
  },
  {
    ...
    texts: [
      <Text>
        ...
        positive or negative. We may accept, reject, or remove reviews in our
        ...
        you hereby grant to us a perpetual, nonexclusive, worldwide,
  ...
  },
  {
    ...
    texts: [
      <Text>
        ...
        Policy:{' '}
        <a href="https://babyfie.eu/privacy">https://babyfie.eu/privacy</a>. By
        ...
        Romania. If you access the Site or the Marketplace Offerings from any
        ...
        laws in Romania, then through your continued use of the Site, you are
        transferring your data to Romania, and you expressly consent to have
        your data transferred to and processed in Romania.
      </Text>,
    ],
  },
  {
  ...
  },
  {
    ...
    texts: [
      <Text>
        ...
        your country to residence. Babyfie SRL and yourself both agree to submit
        to the non-exclusive jurisdiction of the courts of Constanta, which
  ...
  },
  {
    ...
    texts: [
      ...
      <Text>
        ...
        Constanta, Romania. The language of the proceedings shall be Romanian,
  ...
  },
  {
    ...
    texts: [
      <Text>
        ...
        PARTICULAR PURPOSE, AND NONINFRINGEMENT. WE MAKE NO WARRANTIES OR
  ...
  },
  {
    ...
    texts: [
      ...
      <Text>Babyfie S.R.L. </Text>,
      <Text>Salciilor 100B</Text>,
      <Text>Constanta, Constanta 900005 </Text>,
      <Text>Romania</Text>,
      <Text>Phone: +40738467902 </Text>,
      <Text>contact@babyfie.eu</Text>,
    ],
  },
];
...
export const returnData = [
  ...
  },
  {
    ...
    texts: [
      <Text mb="1.5rem">
        To return an item, please email customer service at customers@babyfie.eu
      ...
      <Text>Babyfie SRL </Text>,
      <Text>Attn: Returns </Text>,
      <Text>RMA # </Text>,
      <Text>Salciilor 100B Constanta, Constanta 900005 </Text>,
      <Text>Romania </Text>,
      <Text mt="1.5rem">
  ...
  },
  {
    ...
    texts: [
      <Text>
        ...
        we will process your return or exchange. Please allow at least seven (7)
  ...
  },
  {
    ...
    texts: [
      <Text>
        The following items cannot be returned or exchanged: Items that were
        delivered without any damages{' '}
      </Text>,
      <Text>
  ...
  },
  {
    ...
    texts: [
      ...
      <Text>Phone: +40738467902</Text>,
      <Text>customers@babyfie.eu</Text>,
    ],
  },
];
...
export const shippingData = [
  {
    title: 'WHAT ARE MY SHIPPING & DELIVERY OPTIONS?',
    texts: [
      <Text>
      ...
      <Text>We offer free Standard shipping on Orders over 10000 RON. </Text>,
      <Heading as="h2" size="md">
        Expedited Shipping Fees{' '}
      </Heading>,
      <Text>
        We also offer expedited shipping at the following rates: Standard, 30kg
        - 250 RON{' '}
      </Text>,
      <Text>
        If you select an expedited shipping option, we will follow up after you
      ...
      <Text>
        ...
        the day we accept your order. For more information please refer to our
        Terms.{' '}
      </Text>,
    ],
  },
  {
    ...
    texts: [
      <Text>
        We offer worldwide shipping. Free Standard shipping is not valid on
        international orders.{' '}
      </Text>,
      <Text>
        For information about customs process: Email delivery@babyfie.eu{' '}
      </Text>,
      <Text>
        Please note, we may be subject to various rules and restrictions in
        relation to some international deliveries and you may be subject to
        additional taxes and duties over which we have no control. If such cases
        apply, you are responsible for complying with the laws applicable to the
        country where you live and will be responsible for any such additional
        costs or taxes.{' '}
      </Text>,
    ],
  },
  {
    ...
    texts: [
      ...
      <Text>
        For EU and UK consumers: This does not affect your statutory rights. For
  ...
  },
  {
    ...
    texts: [
      ...
      <Text>Email: contact@babyfie.eu </Text>,
    ],
  },
];
